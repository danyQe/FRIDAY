...
class Backend:
    ...
    def groq1(self):
        ...
        chat=client.chat.completions.create(
            ...
            stream=False,
            tool_choice="auto",
            tools=functions.groq_function_definitions
        )
        ...
        if tool_calls:
            ...
            for tool_call in tool_calls:
                ...
                return self.groq1()
        print("friday:",chat.choices[0].message.content)
        self.messages.append({
                    "role":"assistant",
    ...
    def call_gemini(self, system_message=None):
        ...
        if response:
            ...
            self.system_message_flag = ''
    def call_groq(self, system_message=None):
        if system_message:
    ...
    def send_message(self):
        ...
        with open("messages.json", "a") as f:
                f.write(json.dumps(message, indent=4))
        self.messages.append(message)
        bot_response = self.groq1()
        # self.speak_async(bot_response)
        print("message sending to the client")
...
def no_camera_input():
    ...
    backend.call_groq(system_message=system_message)
...
def upload_file():
    ...
    if file and file.filename.endswith('.pdf'):
        ...
        message = {
                "role": "user",
                "content":f"summarize the {file.filename} file"
            }
